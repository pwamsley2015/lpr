...
const TableSetup = ({ displayUnit, bigBlindSize, onPlayersUpdate }) => {
  ...
  const seatPositions = [
    ...
    { x: 0.5, y: 0.85 },   // Bottom (Seat 1)
    { x: 0.25, y: 0.85 },  // Bottom Left (Seat 2)
    { x: 0.1, y: 0.65 },   // Middle Left (Seat 3)
    { x: 0.1, y: 0.35 },   // Top Left (Seat 4)
    { x: 0.25, y: 0.15 },  // Top Left-Center (Seat 5)
    { x: 0.75, y: 0.15 },  // Top Right-Center (Seat 6)
    { x: 0.9, y: 0.35 },   // Top Right (Seat 7)
    { x: 0.9, y: 0.65 },   // Middle Right (Seat 8)
    { x: 0.75, y: 0.85 }   // Bottom Right (Seat 9)
  ];
